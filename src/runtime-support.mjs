...
export const TANGENT_CAPABLE_TYPES = new Set(["Plane", "HeightField", "Lathe", "Tube", "Loft", "Sweep", "Torus", "Roof", "Stairs"]);
...
export const TANGENT_POLICY = "a tangent-space geometry is required: only Plane/HeightField/Lathe/Tube/Loft/Sweep/Torus/Roof/Stairs carry analytic tangents (Mesh only when it is given uvs, ExtrudedPolygon only on its bevel/taper/axis lane, and neither is admitted by this gate), so this combination would render without tangent space and is refused at compile time";
